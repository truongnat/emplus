---
title: "Module api/grafana/provisioning"
description: "1 file and 1 symbol under api/grafana/provisioning."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "reference/modules/api/grafana/provisioning.md"
  directory: "api/grafana/provisioning"
  fileCount: 1
  symbolCount: 1
  workspace: "api"
  languages:
...
# Module api/grafana/provisioning
...
Provisioning is inferred as a files and storage area. The visible implementation layers are Entry point.
...
- [api/grafana/provisioning/datasources](provisioning/datasources.md) - 1 file, 1 symbol
