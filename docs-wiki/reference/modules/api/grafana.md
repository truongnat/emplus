---
title: "Module api/grafana"
description: "1 file and 1 symbol under api/grafana."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "reference/modules/api/grafana.md"
  directory: "api/grafana"
  fileCount: 1
  symbolCount: 1
  workspace: "api"
  languages:
...
Grafana is inferred as a files and storage area. The visible implementation layers are Entry point.
...
- [api/grafana/provisioning](grafana/provisioning.md) - 1 file, 1 symbol
