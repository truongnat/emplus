---
title: "Module mobile/src/data"
description: "3 files and 34 symbols under mobile/src/data."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "reference/modules/mobile/src/data.md"
  directory: "mobile/src/data"
  fileCount: 3
  symbolCount: 34
  workspace: "mobile"
  languages:
...
Data is inferred as a authentication and access control area. The visible implementation layers are Entry point.
...
- [mobile/src/data/repositories](data/repositories.md) - 3 files, 34 symbols
