---
title: "Module mobile/src/features/profile/components"
description: "2 files and 4 symbols under mobile/src/features/profile/components."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "reference/modules/mobile/src/features/profile/components.md"
  directory: "mobile/src/features/profile/components"
  fileCount: 2
  symbolCount: 4
  workspace: "mobile"
  languages:
...
- Path: `mobile/src/features/profile/components`
- Descendant files: 2
...
Components is inferred as a user and profile management area. The visible implementation layers are UI surface. The module also integrates with @, react-native.
...
- [mobile/src/features/profile/components/BirthDatePickerSheet.tsx](../../../../../files/mobile/src/features/profile/components/BirthDatePickerSheet.tsx.md) — A component representing a date picker sheet with customizable options.
- [mobile/src/features/profile/components/BirthTimePickerSheet.tsx](../../../../../files/mobile/src/features/profile/components/BirthTimePickerSheet.tsx.md) — The `BirthTimePickerSheet` component renders a time picker that allows the user to select their birth time.
