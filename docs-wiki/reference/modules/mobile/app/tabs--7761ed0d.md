...
docsWiki:
  ...
  page: "reference/modules/mobile/app/tabs--7761ed0d.md"
...
A function that returns the icon for a given route in the Ionicons library.
...
Primary flow coverage includes Auth login. Representative files are mobile/app/(tabs)/_layout.tsx, mobile/app/(tabs)/care.tsx, mobile/app/(tabs)/home.tsx, mobile/app/(tabs)/notifications.tsx, mobile/app/(tabs)/profile.tsx. Observed behavior hints: A function that creates a care-themed UI component.
...
- [mobile/app/(tabs)/_layout.tsx](../../../files/mobile/app/tabs--7761ed0d/_layout.tsx.md) — A function that returns the icon for a given route in the Ionicons library.
- [mobile/app/(tabs)/care.tsx](../../../files/mobile/app/tabs--7761ed0d/care.tsx.md) — A function that creates a care-themed UI component.
- [mobile/app/(tabs)/home.tsx](../../../files/mobile/app/tabs--7761ed0d/home.tsx.md) — The HomeScreen component is responsible for rendering the basic layout of the app's home screen.
- [mobile/app/(tabs)/notifications.tsx](../../../files/mobile/app/tabs--7761ed0d/notifications.tsx.md) — NotificationsScreen function
- [mobile/app/(tabs)/profile.tsx](../../../files/mobile/app/tabs--7761ed0d/profile.tsx.md) — The ProfileScreen component renders a user profile screen with various settings and functionality.
- [mobile/app/(tabs)/timeline.tsx](../../../files/mobile/app/tabs--7761ed0d/timeline.tsx.md) — Defines and manages the state for a timeline screen in an authentication gate.
