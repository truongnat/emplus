---
title: "mobile/src/utils/tws.ts"
description: "Used to convert Tailwind CSS classes to styles objects for various styling needs."
layout: "doc"
outline: "deep"
editLink: false
lastUpdated: false
...
docsWiki:
  ...
  page: "reference/files/mobile/src/utils/tws.ts.md"
  relativePath: "mobile/src/utils/tws.ts"
  absolutePath: "/Users/truongdq/tx/GitHub/emplus/mobile/src/utils/tws.ts"
...
- Language: TypeScript
- Source path: `/Users/truongdq/tx/GitHub/emplus/mobile/src/utils/tws.ts`
- Lines: 182
- Symbols: 2

## AI Summary

Used to convert Tailwind CSS classes to styles objects for various styling needs.

## Public API

- `function tws( ...inputs: ClassValue[] ): ViewStyle | TextStyle | ImageStyle`
- `function twStyles(...inputs: ClassValue[]): any`

## Symbols

### function `tws`

- Signature: `function tws( ...inputs: ClassValue[] ): ViewStyle | TextStyle | ImageStyle`
- Lines: 16-24
- Exported: yes
...
- Signature: `function twStyles(...inputs: ClassValue[]): any`
- Lines: 30-181
- Exported: yes
