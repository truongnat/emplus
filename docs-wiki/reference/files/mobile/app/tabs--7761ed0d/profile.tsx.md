---
title: "mobile/app/(tabs)/profile.tsx"
description: "The ProfileScreen component renders a user profile screen with various settings and functionality."
layout: "doc"
outline: "deep"
editLink: false
lastUpdated: false
...
docsWiki:
  ...
  page: "reference/files/mobile/app/tabs--7761ed0d/profile.tsx.md"
  relativePath: "mobile/app/(tabs)/profile.tsx"
  absolutePath: "/Users/truongdq/tx/GitHub/emplus/mobile/app/(tabs)/profile.tsx"
...
- Language: TypeScript
- Source path: `/Users/truongdq/tx/GitHub/emplus/mobile/app/(tabs)/profile.tsx`
- Lines: 662
- Symbols: 4
...
The ProfileScreen component renders a user profile screen with various settings and functionality.

### Usage Notes

- Note that this component is responsible for handling various settings such as avatar image selection, user name display, and basic profile actions.
...
- Signature: `function ProfileScreen()`
- Lines: 288-661
- Exported: yes
...
- Signature: `function createProfileStyles(c: SemanticColors)`
- Lines: 28-227
- Exported: no
...
- Signature: `interface SettingItemProps`
- Lines: 229-236
- Exported: no
...
- Signature: `function SettingItem({ icon, label, sublabel, rightElement, onPress, isLast, }: SettingItemProps)`
- Lines: 238-286
- Exported: no
