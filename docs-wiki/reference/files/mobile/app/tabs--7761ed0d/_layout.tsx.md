...
description: "A function that returns the icon for a given route in the Ionicons library."
layout: "doc"
outline: "deep"
editLink: false
lastUpdated: false
...
docsWiki:
  ...
  page: "reference/files/mobile/app/tabs--7761ed0d/_layout.tsx.md"
...
- route string, focused boolean

### Usage Notes

- The returned icon is determined by the matched route and focus state.
