---
title: "mobile/app/(tabs)/notifications.tsx"
description: "NotificationsScreen function"
layout: "doc"
outline: "deep"
editLink: false
lastUpdated: false
...
docsWiki:
  ...
  page: "reference/files/mobile/app/tabs--7761ed0d/notifications.tsx.md"
  relativePath: "mobile/app/(tabs)/notifications.tsx"
  absolutePath: "/Users/truongdq/tx/GitHub/emplus/mobile/app/(tabs)/notifications.tsx"
...
- Language: TypeScript
- Source path: `/Users/truongdq/tx/GitHub/emplus/mobile/app/(tabs)/notifications.tsx`
- Lines: 510
- Symbols: 4
...
- This function is used to display the list of notifications and handle user interactions.
- It uses `useAuthGridChrome`, `useMarkNotificationRead` and `useMarkAllNotificationsRead` hooks.
...
- Signature: `function formatRelativeTime(iso: string): string`
- Lines: 27-38
- Exported: no
...
- Signature: `function createNotificationStyles(c: SemanticColors)`
- Lines: 40-238
- Exported: no
- Summary: returns styles object for notifications cards with various colors.
...
- Signature: `function NotificationCard({ notification, styles, onOpen, }: { notification: NotificationModule.InAppNotification; styles: ReturnType<typeof createNotificationStyles>; onOpen: () => void; })`
- Lines: 446-509
- Exported: no
