---
title: "mobile/app/(tabs)/care.tsx"
description: "A function that creates a care-themed UI component."
layout: "doc"
outline: "deep"
editLink: false
lastUpdated: false
...
docsWiki:
  ...
  page: "reference/files/mobile/app/tabs--7761ed0d/care.tsx.md"
  relativePath: "mobile/app/(tabs)/care.tsx"
  absolutePath: "/Users/truongdq/tx/GitHub/emplus/mobile/app/(tabs)/care.tsx"
...
- Language: TypeScript
- Source path: `/Users/truongdq/tx/GitHub/emplus/mobile/app/(tabs)/care.tsx`
- Lines: 728
- Symbols: 5
...
A function that creates a care-themed UI component.

### Usage Notes

- This function returns a care-themed UI component with various styled views and animations.
- To use this function, import it in your App.tsx and call the createCareStyles function with an instance of SemanticColors and a boolean indicating whether to be dark mode.
...
- Signature: `function MoodOrb({ color }: { color: string })`
- Lines: 38-86
- Exported: no
...
- Signature: `interface CareSuggestion`
- Lines: 110-113
- Exported: no
...
- Signature: `interface ExtendedMaleSuggestions`
- Lines: 115-119
- Exported: no
...
### function `createCareStyles`

- Signature: `function createCareStyles(c: SemanticColors, isDark: boolean)`
- Lines: 121-410
- Exported: no
