...
docsWiki:
  ...
  page: "reference/files/api/openapi.json.md"
  relativePath: "api/openapi.json"
  absolutePath: "/Users/truongdq/tx/GitHub/emplus/api/openapi.json"
  module: "api"
  workspace: "api"
  language: "JSON"
  symbolCount: 1
...
- Language: JSON
- Source path: `/Users/truongdq/tx/GitHub/emplus/api/openapi.json`
- Lines: 2252
- Symbols: 1
...
- describe API endpoints, security schemes and schemas

### Usage Notes

- The OpenAPI specification defines a standard interface for APIs. It describes the available methods, parameters, and response formats.

## Public API

- `Plain-text index (2252 lines)`

## Symbols

### source `(file)`

- Signature: `Plain-text index (2252 lines)`
- Lines: 1-2252
- Exported: yes
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/PasswordResetAck"
                }
              }
            }
          },
        ...
        "parameters": [
          {
            "in": "query",
            "name": "status",
            "description": "Lọc theo trạng thái (PAID, PENDING, OVER_BUDGET, DRAFT hoặc nhãn tiếng Việt tương ứng). Bỏ qua để lấy tất cả.",
            "schema": {
              "type": "string"
            }
          },
