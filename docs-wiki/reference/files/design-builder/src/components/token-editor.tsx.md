---
title: "design-builder/src/components/token-editor.tsx"
description: "The TokenEditor component provides a text area for editing and managing tokens in the design-builder."
layout: "doc"
outline: "deep"
editLink: false
lastUpdated: false
...
docsWiki:
  ...
  page: "reference/files/design-builder/src/components/token-editor.tsx.md"
  relativePath: "design-builder/src/components/token-editor.tsx"
  absolutePath: "/Users/truongdq/tx/GitHub/emplus/design-builder/src/components/token-editor.tsx"
...
- Language: TypeScript
- Source path: `/Users/truongdq/tx/GitHub/emplus/design-builder/src/components/token-editor.tsx`
- Lines: 409
- Symbols: 1

## AI Summary

The TokenEditor component provides a text area for editing and managing tokens in the design-builder.

### Responsibilities

- Input, manage, and display tokens, including selecting them, copying and pasting, and updating their properties.

### Usage Notes

- The TokenEditor also includes functionality to handle errors and edge cases when working with complex token structures.
...
- Signature: `function TokenEditor()`
- Lines: 15-408
- Exported: yes
