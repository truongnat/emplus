---
title: "Search Read / List"
description: "Search Read / List captures the read / list workflow inside search. It spans 3 workspaces."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "features/search-list.md"
  featureId: "search-list"
  domain: "search"
  action: "list"
  fileCount: 52
---
...
- Entry points (FE): design-builder/src/page-components/builder-page.tsx, mobile/src/features/budget/hooks/useBudgetData.ts, mobile/src/features/home/index.ts, mobile/src/features/timeline/components/TimelineImageViewer.tsx, mobile/src/theme/engine.tsx, mobile/src/theme/gradients.ts, mobile/src/utils/home-helpers.ts, api/src/__tests__/validation.test.ts
...
flowchart LR
  actor_1["Caller"]
  feature_search_list["Search Read / List\nFeature boundary"]
  actor_1 --> feature_search_list
  ext_1["bun"]
  feature_search_list --> ext_1
  ext_2["@hono"]
  feature_search_list --> ext_2
  ext_3["hono"]
  feature_search_list --> ext_3
  ext_4["node"]
  feature_search_list --> ext_4
  ext_5["postgres"]
  feature_search_list --> ext_5
  ext_6["zod"]
  feature_search_list --> ext_6
```

## Detail Design

- Data stores: Primary database, Session / token state
- Integrations: bun, @hono, hono, node, postgres, zod, ioredis, @faker-js, nodemailer, minio, @, lucide-react, react, sonner, react-native, react-native-safe-area-context, react-native-reanimated, expo-linear-gradient, react-native-gesture-handler, @shopify, @expo, expo-router, expo-image, @tanstack, expo-status-bar, @react-native-async-storage, clsx, tailwind-merge, expo-clipboard, expo-document-picker, expo-image-picker, expo-notifications
...
flowchart LR
  ...
  cmp_2["useBudgetData.ts\nUI surface"]
  cmp_3["index.ts\nUI surface"]
  cmp_4["TimelineImageViewer.tsx\nUI surface"]
  cmp_5["engine.tsx\nUI surface"]
  cmp_6["gradients.ts\nUI surface"]
  cmp_7["home-helpers.ts\nUI surface"]
  cmp_8["validation.test.ts\nEntry point"]
  cmp_1 --> cmp_2
  cmp_2 --> cmp_3
  cmp_3 --> cmp_4
  cmp_4 --> cmp_5
