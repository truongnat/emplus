...
description: "Storage Verification captures the verification workflow inside storage. It spans 2 workspaces. Key flows include Credential validation, Auth login, Auth login."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "features/storage-verify.md"
  featureId: "storage-verify"
  domain: "storage"
  action: "verify"
  fileCount: 25
---
...
Storage Verification captures the verification workflow inside storage. It spans 2 workspaces. Key flows include Credential validation, Auth login, Auth login.
...
flowchart LR
  actor_1["Caller"]
  feature_storage_verify["Storage Verification\nFeature boundary"]
  actor_1 --> feature_storage_verify
  ext_1["bun"]
  feature_storage_verify --> ext_1
  ext_2["zod"]
  feature_storage_verify --> ext_2
  ext_3["hono"]
  feature_storage_verify --> ext_3
  ext_4["ioredis"]
  feature_storage_verify --> ext_4
  ext_5["google-auth-library"]
  feature_storage_verify --> ext_5
  ext_6["jose"]
  feature_storage_verify --> ext_6
```
