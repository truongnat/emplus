---
title: "Reporting Login"
description: "Reporting Login captures the login workflow inside reporting. It spans 2 workspaces. Key flows include Auth login, Auth registration, Auth login."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "features/reporting-login.md"
  featureId: "reporting-login"
  domain: "reporting"
  action: "login"
  fileCount: 26
---
...
Reporting Login captures the login workflow inside reporting. It spans 2 workspaces. Key flows include Auth login, Auth registration, Auth login.
...
flowchart LR
  actor_1["Caller"]
  feature_reporting_login["Reporting Login\nFeature boundary"]
  actor_1 --> feature_reporting_login
  ext_1["bun"]
  feature_reporting_login --> ext_1
  ext_2["@hono"]
  feature_reporting_login --> ext_2
  ext_3["hono"]
  feature_reporting_login --> ext_3
  ext_4["node"]
  feature_reporting_login --> ext_4
  ext_5["postgres"]
  feature_reporting_login --> ext_5
  ext_6["zod"]
  feature_reporting_login --> ext_6
```
