...
description: "Authentication Verification captures the verification workflow inside authentication. It spans 2 workspaces. Key flows include Credential validation, Auth login, Auth login."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "features/auth-verify.md"
  featureId: "auth-verify"
  domain: "auth"
  action: "verify"
  fileCount: 32
---
...
Authentication Verification captures the verification workflow inside authentication. It spans 2 workspaces. Key flows include Credential validation, Auth login, Auth login.

### Boundaries

- Workspaces: @emplus/api, @emplus/mobile
- Entry points (FE): mobile/src/features/auth/components/VerifyOtpHeroSection.tsx, mobile/src/features/auth/verifyOtpScreen.styles.ts, mobile/src/hooks/a11y.ts, api/src/__tests__/validation.test.ts, api/src/dto/auth.dto.ts, api/src/dto/budget.dto.ts, api/src/dto/care.dto.ts, api/src/dto/couples.dto.ts
...
flowchart LR
  ...
  feature_auth_verify["Authentication Verification\nFeature boundary"]
  actor_1 --> feature_auth_verify
  actor_2 --> feature_auth_verify
  ext_1["bun"]
  feature_auth_verify --> ext_1
  ext_2["zod"]
  feature_auth_verify --> ext_2
  ext_3["hono"]
  feature_auth_verify --> ext_3
  ext_4["ioredis"]
  feature_auth_verify --> ext_4
  ext_5["google-auth-library"]
  feature_auth_verify --> ext_5
  ext_6["jose"]
  feature_auth_verify --> ext_6
```

## Detail Design

- Data stores: Session / token state, Primary database
- Integrations: bun, zod, hono, ioredis, google-auth-library, jose, node, postgres, nodemailer, minio, @, @expo-google-fonts, expo-font, expo-router, expo-splash-screen, expo-status-bar, react, react-native, react-native-safe-area-context, react-native-reanimated, expo-linear-gradient, react-native-keyboard-aware-scroll-view, @expo, @tanstack
...
flowchart LR
  ...
  cmp_2["verifyOtpScreen.styles.ts\nUI surface"]
  cmp_3["a11y.ts\nUI surface"]
  cmp_4["validation.test.ts\nEntry point"]
  cmp_5["auth.dto.ts\nEntry point"]
  cmp_6["budget.dto.ts\nEntry point"]
  cmp_7["care.dto.ts\nEntry point"]
  cmp_8["couples.dto.ts\nEntry point"]
  cmp_1 --> cmp_2
  cmp_2 --> cmp_3
  cmp_3 --> cmp_4
  cmp_4 --> cmp_5
...
| --- | --- | --- | --- |
| [mobile/src/features/auth/components/VerifyOtpHeroSection.tsx](../reference/files/mobile/src/features/auth/components/VerifyOtpHeroSection.tsx.md) | @emplus/mobile | UI surface | Matches the verification action heuristics for this feature. |
| [mobile/src/features/auth/verifyOtpScreen.styles.ts](../reference/files/mobile/src/features/auth/verifyOtpScreen.styles.ts.md) | @emplus/mobile | UI surface | Matches the verification action heuristics for this feature. |
| [mobile/src/hooks/a11y.ts](../reference/files/mobile/src/hooks/a11y.ts.md) | @emplus/mobile | UI surface | Matches the verification action heuristics for this feature. |
...
| [api/src/shared/validators/index.ts](../reference/files/api/src/shared/validators/index.ts.md) | @emplus/api | Entry point | Matches the verification action heuristics for this feature. |
...
| [mobile/app/verify-otp.tsx](../reference/files/mobile/app/verify-otp.tsx.md) | @emplus/mobile | Entry point | Matches the verification action heuristics for this feature. |
...
| [mobile/src/features/auth/components/VerifyOtpForm.tsx](../reference/files/mobile/src/features/auth/components/VerifyOtpForm.tsx.md) | @emplus/mobile | Entry point | Matches the verification action heuristics for this feature. |
...
| [mobile/assets/lottie/verify-otp-password-auth.json](../reference/files/mobile/assets/lottie/verify-otp-password-auth.json.md) | @emplus/mobile | Utility | Matches the verification action heuristics for this feature. |
| [mobile/src/lottie/inventory.ts](../reference/files/mobile/src/lottie/inventory.ts.md) | @emplus/mobile | Utility | Matches the verification action heuristics for this feature. |