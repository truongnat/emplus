---
title: "Authentication Read / List"
description: "Authentication Read / List captures the read / list workflow inside authentication. It spans 3 workspaces."
layout: "doc"
outline:
  - 2
  - 3
...
- Entry points (FE): design-builder/src/components/token-category-list.tsx, design-builder/src/page-components/builder-page.tsx, mobile/src/features/budget/hooks/useBudgetData.ts, mobile/src/features/home/index.ts, mobile/src/features/timeline/components/TimelineImageViewer.tsx, mobile/src/hooks/a11y.ts, mobile/src/theme/engine.tsx, mobile/src/theme/gradients.ts
...
flowchart LR
  ...
  feature_auth_list["Authentication Read / List\nFeature boundary"]
  actor_1 --> feature_auth_list
  actor_2 --> feature_auth_list
  ext_1["bun"]
  feature_auth_list --> ext_1
  ext_2["@hono"]
  feature_auth_list --> ext_2
  ext_3["hono"]
  feature_auth_list --> ext_3
  ext_4["node"]
  feature_auth_list --> ext_4
  ext_5["postgres"]
  feature_auth_list --> ext_5
  ext_6["zod"]
  feature_auth_list --> ext_6
```

## Detail Design

- Data stores: Primary database, Session / token state
- Integrations: bun, @hono, hono, node, postgres, zod, ioredis, @faker-js, nodemailer, minio, @, lucide-react, react, sonner, react-colorful, @radix-ui, @expo-google-fonts, expo-font, expo-router, expo-splash-screen, expo-status-bar, *.flow, fs, path, react-native, react-native-safe-area-context, react-native-reanimated, expo-linear-gradient, react-native-gesture-handler, @shopify, @expo, @react-native-async-storage, expo-image, @tanstack, clsx, tailwind-merge, expo-clipboard, expo-document-picker, expo-image-picker, expo-notifications
...
flowchart LR
  ...
  cmp_3["useBudgetData.ts\nUI surface"]
  cmp_4["index.ts\nUI surface"]
  cmp_5["TimelineImageViewer.tsx\nUI surface"]
  cmp_6["a11y.ts\nUI surface"]
  cmp_7["engine.tsx\nUI surface"]
  cmp_8["gradients.ts\nUI surface"]
  cmp_1 --> cmp_2
...
| [mobile/src/features/budget/hooks/useBudgetData.ts](../reference/files/mobile/src/features/budget/hooks/useBudgetData.ts.md) | @emplus/mobile | UI surface | Matches the read / list action heuristics for this feature. |
...
| [mobile/src/hooks/a11y.ts](../reference/files/mobile/src/hooks/a11y.ts.md) | @emplus/mobile | UI surface | Matches the read / list action heuristics for this feature. |
...
| [mobile/src/theme/gradients.ts](../reference/files/mobile/src/theme/gradients.ts.md) | @emplus/mobile | UI surface | Matches the read / list action heuristics for this feature. |
...
| [mobile/src/features/home/components/UpcomingEvents.tsx](../reference/files/mobile/src/features/home/components/UpcomingEvents.tsx.md) | @emplus/mobile | Entry point | Matches the read / list action heuristics for this feature. |
...
| [mobile/src/domain/repositories/modules.repository.ts](../reference/files/mobile/src/domain/repositories/modules.repository.ts.md) | @emplus/mobile | Repository / persistence | Matches the read / list action heuristics for this feature. |
...
| [mobile/src/components/atoms/Skeleton.tsx](../reference/files/mobile/src/components/atoms/Skeleton.tsx.md) | @emplus/mobile | Model / contract | Matches the read / list action heuristics for this feature. |
...
| [mobile/src/components/atoms/Avatar.tsx](../reference/files/mobile/src/components/atoms/Avatar.tsx.md) | @emplus/mobile | Utility | Matches the read / list action heuristics for this feature. |
| [mobile/src/theme/aura-colors.ts](../reference/files/mobile/src/theme/aura-colors.ts.md) | @emplus/mobile | Utility | Matches the read / list action heuristics for this feature. |
