---
title: "Integrations Read / List"
description: "Integrations Read / List captures the read / list workflow inside integrations. It spans 3 workspaces."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "features/integration-list.md"
  featureId: "integration-list"
  domain: "integration"
  action: "list"
  fileCount: 39
---

# Integrations Read / List
...
- Entry points (FE): design-builder/src/page-components/builder-page.tsx, mobile/src/theme/engine.tsx, mobile/src/theme/gradients.ts, api/src/__tests__/validation.test.ts, api/src/config/env.ts, api/src/db/migrate.ts, api/src/dto/notifications.dto.ts, api/src/engines/anniversary.ts
...
flowchart LR
  actor_1["Caller"]
  feature_integration_list["Integrations Read / List\nFeature boundary"]
  actor_1 --> feature_integration_list
  ext_1["bun"]
  feature_integration_list --> ext_1
  ext_2["@hono"]
  feature_integration_list --> ext_2
  ext_3["hono"]
  feature_integration_list --> ext_3
  ext_4["node"]
  feature_integration_list --> ext_4
  ext_5["postgres"]
  feature_integration_list --> ext_5
  ext_6["zod"]
  feature_integration_list --> ext_6
```

## Detail Design

- Data stores: Primary database, Session / token state
- Integrations: bun, @hono, hono, node, postgres, zod, ioredis, @faker-js, nodemailer, minio, @, lucide-react, react, sonner, react-native, react-native-safe-area-context, react-native-reanimated, expo-linear-gradient, react-native-gesture-handler, @react-native-async-storage, clsx, tailwind-merge, expo-clipboard, expo-document-picker, expo-image-picker, expo-notifications
