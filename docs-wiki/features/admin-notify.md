---
title: "Administration Notify"
description: "Administration Notify captures the notify workflow inside administration. It spans 2 workspaces."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "features/admin-notify.md"
  featureId: "admin-notify"
  domain: "admin"
  action: "notify"
  fileCount: 23
---
...
Administration Notify captures the notify workflow inside administration. It spans 2 workspaces.
...
flowchart LR
  actor_1["Caller"]
  feature_admin_notify["Administration Notify\nFeature boundary"]
  actor_1 --> feature_admin_notify
  ext_1["bun"]
  feature_admin_notify --> ext_1
  ext_2["@hono"]
  feature_admin_notify --> ext_2
  ext_3["hono"]
  feature_admin_notify --> ext_3
  ext_4["node"]
  feature_admin_notify --> ext_4
  ext_5["postgres"]
  feature_admin_notify --> ext_5
  ext_6["zod"]
  feature_admin_notify --> ext_6
```
