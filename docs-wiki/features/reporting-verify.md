...
description: "Reporting Verification captures the verification workflow inside reporting. It spans 2 workspaces. Key flows include Credential validation, Auth login, Auth login."
layout: "doc"
outline:
  - 2
  - 3
...
docsWiki:
  ...
  page: "features/reporting-verify.md"
  featureId: "reporting-verify"
  domain: "reporting"
  action: "verify"
  fileCount: 22
---
...
Reporting Verification captures the verification workflow inside reporting. It spans 2 workspaces. Key flows include Credential validation, Auth login, Auth login.
...
flowchart LR
  actor_1["Caller"]
  feature_reporting_verify["Reporting Verification\nFeature boundary"]
  actor_1 --> feature_reporting_verify
  ext_1["bun"]
  feature_reporting_verify --> ext_1
  ext_2["zod"]
  feature_reporting_verify --> ext_2
  ext_3["hono"]
  feature_reporting_verify --> ext_3
  ext_4["ioredis"]
  feature_reporting_verify --> ext_4
  ext_5["google-auth-library"]
  feature_reporting_verify --> ext_5
  ext_6["jose"]
  feature_reporting_verify --> ext_6
```
