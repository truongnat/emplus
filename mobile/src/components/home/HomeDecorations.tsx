...
export function RingingBell() {
    ...
    return (
        <Animated.View style={animatedStyle}>
            <Ionicons name="notifications-outline" size={24} color={(palette as any)['slate-600']} />
            <View style={tws("absolute -top-0.5 -right-0.5 w-3 h-3 bg-rose-500 rounded-full border-2 border-white/90")} />
        </Animated.View>
    );
}
