...
export function TimelineDateGroupHeader({ dateString }: TimelineDateGroupHeaderProps) {
    ...
    return (
        <View style={tws("flex-row items-center mb-4 mt-8 mx-6")}>
            <View style={tws("w-12 items-center justify-center")}>
                ...
                <View style={tws("absolute top-0 bottom-[-16px] w-[2px] bg-slate-200/60")} />

                <PulsingRing />
                <View style={tws("w-5 h-5 rounded-full bg-white border-[2.5px] border-primary/20 items-center justify-center z-10 shadow-sm")}>
            ...
            <Text
                style={[
                    ...
                    tws("text-[13px] font-bold uppercase tracking-widest ml-0.5",
